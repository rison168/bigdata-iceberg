 ...
 * @NAME: SparkManifestsApplication
 * @USER: Rison
 * @DATE: 2022/9/27 14:35
 * @PROJECT_NAME: bigdata-iceberg
 * */

object SparkManifestsApplication {
...
/*
/usr/hdp/2.2.0.0-2041/spark/bin/spark-submit  --class com.rison.bigdata.SparkManifestsApplication \
--master yarn \
--deploy-mode client \
--driver-memory 500m \
