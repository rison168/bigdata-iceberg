 ...
 * @NAME: SparkDataFilesApplication
 * @USER: Rison
 * @DATE: 2022/9/27 14:23
 * @PROJECT_NAME: bigdata-iceberg
 * */

object SparkDataFilesApplication {
...
/*
/usr/hdp/2.2.0.0-2041/spark/bin/spark-submit  --class com.rison.bigdata.SparkDataFilesApplication \
--master yarn \
--deploy-mode client \
--driver-memory 500m \
